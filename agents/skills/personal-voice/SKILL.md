...
**例外**：有 substance 的指引短语**保留**——例如「具体到 eval」「在这里你会发现」「我们首先要知道的一点是」「在跨过基础的质量门槛后」。这些不是空过渡，而是在指出"接下来要讲一个具体的 X"，对读者跟上节奏有用。
...
- **不要把 `——` 单独占行做段落分隔条 / visual divider**——这是 AI / markdown 渲染思路，yujiachen 用自然段落推进就够了
